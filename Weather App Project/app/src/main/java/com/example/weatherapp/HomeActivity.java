...
public class HomeActivity extends AppCompatActivity {
        ...
        binding.layout.micSearchId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    Log.d("Error Voice", "Ошибка распознавания:  "+e);
                }
            }
        });
    }
    ...
    private void searchCity(String cityName) {
        if (cityName == null || cityName.isEmpty()) {
            Toaster.errorToast(this, "Пожалуйста, введите название города");
        } else {
    ...
    private void setLatitudeLongitudeUsingCity(String cityName) {
        ...
        }, error -> Toaster.errorToast(this, "Пожалуйста, введите корректное название города"));
    ...
    private void updateUI() {
        ...
        binding.layout.pressureTv.setText(pressure + " мм");
        binding.layout.windTv.setText(wind_speed + " км/ч");
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_CODE) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Toaster.successToast(this, "Разрешение получено");
                getDataUsingNetwork();
            } else {
                Toaster.errorToast(this, "Отказано в разрешении");
                finish();
            }
        }
    }
        ...
        appUpdateInfoTask.addOnSuccessListener(appUpdateInfo -> {
            if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE
                ...
                try {
                    ...
                    Toaster.errorToast(this, "Ошибка обновления");
                }
            }
        });
    }
